...
#     layer_file = f'./feature/{args.data_name}_{args.model_name}_train_layers.npy'
...
#     # --- 加载测试集特征 ---
#     heads_file_test = f'./feature/{args.data_name}_{args.model_name}_test_heads.npy'
#     layer_file_test = f'./feature/{args.data_name}_{args.model_name}_test_layers.npy'
#     labels_file_test = f'./feature/{args.data_name}_{args.model_name}_test_labels.npy'
...
#     m_auc, m_auroc, d_clf = probe(layer_num, head_num, head_wise_activations_train, labels_train, head_wise_activations_test, labels_test, max_iter=200)
...
if __name__ == '__main__':
    ...
    print(pd.Series(labels_train).value_counts(normalize=True))
    ...
    m_train_auc, m_train_auroc, m_val_auc, m_val_auroc, m_auc, m_auroc, d_clf = probe_val(
        layer_num, head_num,
        head_wise_activations_train, labels_train,
        X_val, y_val,
        X_test, y_test,
    ...
    print(m_train_auc)
    print("m_auc:", m_auc.max())
    print("m_train_auc:", m_train_auc.max())
    print("m_val_auc:", m_val_auc.max())